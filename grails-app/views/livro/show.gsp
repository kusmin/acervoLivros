    ...
    <body>
        ...
        <div class="nav" role="navigation">
            <ul>
                ...
                <li><g:link class="edit" action="editImages" resource="${this.livro}"><g:message code="livro.featuredImageUrl.edit.label" default="Editar  Imagens" /></g:link></li>
            </ul>
        </div>
        <div id="show-livro" class="content scaffold-show" role="main">
            ...
            <f:display bean="livro" except="capaByte,capaString"/>
            <g:if test="${this.livro.capaByte}">
                <img src="<g:createLink controller="livro" action="featuredImage" id="${this.livro.id}"/>" width="400"/>
            </g:if>
